...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Prepare LAMMPS atomic data and input for normal MatterTune-MatterSim ML-IAP MD from an electrolyte PDB."
    )
...
def main() -> None:
    ...
    print(f"restart_1={args.restart_1}")
    print(f"restart_2={args.restart_2}")
